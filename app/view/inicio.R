...
ui <- function(id) {  
  ...
  tagList(
    fluidPage(
      fluidRow(
        class = "image-container bg-light d-flex justify-content-center align-items-center p-0 m-0", # Adicionada a classe image-container e outras classes de utilidade do Bootstrap
        div(
